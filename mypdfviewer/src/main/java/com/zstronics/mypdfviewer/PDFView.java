 ...
 */
package com.zstronics.mypdfviewer;
...
import com.zstronics.mypdfviewer.exception.PageRenderingException;
import com.zstronics.mypdfviewer.link.DefaultLinkHandler;
import com.zstronics.mypdfviewer.link.LinkHandler;
import com.zstronics.mypdfviewer.listener.Callbacks;
import com.zstronics.mypdfviewer.listener.OnDrawListener;
import com.zstronics.mypdfviewer.listener.OnErrorListener;
import com.zstronics.mypdfviewer.listener.OnLoadCompleteListener;
import com.zstronics.mypdfviewer.listener.OnLongPressListener;
import com.zstronics.mypdfviewer.listener.OnPageChangeListener;
import com.zstronics.mypdfviewer.listener.OnPageErrorListener;
import com.zstronics.mypdfviewer.listener.OnPageScrollListener;
import com.zstronics.mypdfviewer.listener.OnRenderListener;
import com.zstronics.mypdfviewer.listener.OnTapListener;
import com.zstronics.mypdfviewer.model.PagePart;
import com.zstronics.mypdfviewer.scroll.ScrollHandle;
import com.zstronics.mypdfviewer.source.AssetSource;
import com.zstronics.mypdfviewer.source.ByteArraySource;
import com.zstronics.mypdfviewer.source.DocumentSource;
import com.zstronics.mypdfviewer.source.FileSource;
import com.zstronics.mypdfviewer.source.InputStreamSource;
import com.zstronics.mypdfviewer.source.UriSource;
import com.zstronics.mypdfviewer.util.Constants;
import com.zstronics.mypdfviewer.util.FitPolicy;
import com.zstronics.mypdfviewer.util.MathUtils;
import com.zstronics.mypdfviewer.util.SnapEdge;
import com.zstronics.mypdfviewer.util.Util;
...
public class PDFView extends RelativeLayout {
    ...
    public static final float DEFAULT_MAX_SCALE = 24.0f;
    ...
    private float optimalPageWidth = 0f, optimalPageHeight = 0f;
    ...
    void loadComplete(PdfFile pdfFile, int pageWidth, int pageHeight) {
        state = State.LOADED;
