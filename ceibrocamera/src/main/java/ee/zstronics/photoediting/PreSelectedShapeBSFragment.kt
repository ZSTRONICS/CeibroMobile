...
import ee.zstronics.photoediting.ColorPickerAdapter.OnColorPickerClickListener

class PreSelectedShapeBSFragment : BottomSheetDialogFragment(), SeekBar.OnSeekBarChangeListener {
