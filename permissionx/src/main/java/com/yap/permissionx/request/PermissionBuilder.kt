...
class PermissionBuilder(
    ...
    fun showHandlePermissionDialog(
        ...
        message: String,
        positiveText: String,
        negativeText: String?, cancelAble: Boolean = false
    ) {
        ...
        showHandlePermissionDialog(chainTask, showReasonOrGoSettings, defaultDialog, cancelAble)
    }
    ...
    fun showHandlePermissionDialog(
        chainTask: ChainTask,
        showReasonOrGoSettings: Boolean,
        dialog: RationaleDialog, cancelAble: Boolean = false
    ) {
