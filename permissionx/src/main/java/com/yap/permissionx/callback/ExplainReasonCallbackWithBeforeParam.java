...
/**
 * Callback for {@link com.yap.permissionx.request.PermissionBuilder#onExplainRequestReason(ExplainReasonCallbackWithBeforeParam)} method.
 *
 * @author Digitify
 * @since 2020/6/7
 */
public interface ExplainReasonCallbackWithBeforeParam {
     ...
     * @param beforeRequest
     *          Indicate it's before or after permission request. Work with {@link com.yap.permissionx.request.PermissionBuilder#explainReasonBeforeRequest()}
     */
