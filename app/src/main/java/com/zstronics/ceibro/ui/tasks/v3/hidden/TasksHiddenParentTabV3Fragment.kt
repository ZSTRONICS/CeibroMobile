...
import com.zstronics.ceibro.databinding.FragmentTasksHiddenParentTabV3Binding
import com.zstronics.ceibro.ui.socket.LocalEvents
import com.zstronics.ceibro.ui.tasks.v3.bottomsheets.ApprovalTypeBottomSheet
import com.zstronics.ceibro.ui.tasks.v3.bottomsheets.ProjectListHiddenBottomSheet
import com.zstronics.ceibro.ui.tasks.v3.bottomsheets.TagsHiddenBottomSheet
...
import com.zstronics.ceibro.ui.tasks.v3.bottomsheets.UsersHiddenBottomSheet
...
@AndroidEntryPoint
class TasksHiddenParentTabV3Fragment :
    BaseNavViewModelFragment<FragmentTasksHiddenParentTabV3Binding, ITasksHiddneParentTabV3.State, TasksHiddenParentTabV3VM>() {

    override val bindingVariableId = BR.viewModel
    override val bindingViewStateVariableId = BR.viewState
    override val viewModel: TasksHiddenParentTabV3VM by viewModels()
    override val layoutResId: Int = R.layout.fragment_tasks_hidden_parent_tab_v3
...
//            }
    ...
    lateinit var adapter: TasksHiddenParentV3TabLayoutAdapter
...
//            adapter.getTabIcon(position).let { tab.setIcon(it) }     //This default view shows icon on top of text, not on start as desired
    ...
    private fun chooseUserType(
        viewModel: TasksHiddenParentTabV3VM,
        ...
        val sheet = UsersHiddenBottomSheet(viewModel, {
    ...
    private fun chooseTagsType(model: TasksHiddenParentTabV3VM, callback: (String) -> Unit) {
        val sheet = TagsHiddenBottomSheet(model) {
    ...
    private fun chooseProjectFromList(
        ...
        val sheet = ProjectListHiddenBottomSheet(viewModel) {
