package com.zstronics.ceibro.ui.locationv2.locationdrawing.adapter
...
class LocationDrawingAdapter constructor(
    val downloadedDrawingV2Dao: DownloadedDrawingV2Dao,
    val networkConnectivityObserver: NetworkConnectivityObserver
) :
    RecyclerView.Adapter<LocationDrawingAdapter.NewDrawingGroupViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        return NewDrawingGroupViewHolder(
            LayoutlocationdrawingitemlistingBinding.inflate(
...
//            this.listItems.clear()
    ...
    inner class NewDrawingGroupViewHolder(private val binding: LayoutlocationdrawingitemlistingBinding) :
            ...
            while (true) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    if (status.toInt() == DownloadManager.STATUS_FAILED) {
                        ...
                        fileName?.let {
                            val fileAbsolutePath = Filer.copyFileToInternalStorageExtension(context, uri, "", it)
                            GlobalScope.launch {
