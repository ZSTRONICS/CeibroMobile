...
import com.zstronics.ceibro.ui.locationv2.LocationsV2VM
import com.zstronics.ceibro.ui.tasks.v3.bottomsheets.adapters.LocationUsersBottomSheetTabLayoutAdapter

class LocationUsersBottomSheet(
    val viewModel: LocationsV2VM,
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter = LocationUsersBottomSheetTabLayoutAdapter(requireActivity(), viewModel, {
