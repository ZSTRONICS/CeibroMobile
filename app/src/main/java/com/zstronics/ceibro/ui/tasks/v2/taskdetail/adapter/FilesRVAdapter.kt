...
class FilesRVAdapter constructor(
    ...
    var fileClickListener: ((view: View, position: Int, data: TaskFiles, downloadedData: CeibroDownloadDrawingV2) -> Unit)? =
        null
    ...
    var downloadFileClickListener: ((textView: TextView, ivDownload: AppCompatImageView, downloaded: AppCompatImageView, data: TaskFiles, tag: String) -> Unit)? =
        null

    fun downloadFileCallBack(itemClickListener: ((textView: TextView, ivDownload: AppCompatImageView, downloaded: AppCompatImageView, data: TaskFiles, tag: String) -> Unit)?) {
