...
object SocketHandler {
    ...
    enum class TaskEvent {
        ...
        TASK_HIDDEN, TASK_SHOWN, JOINED_TASK, UN_CANCEL_TASK, IB_TASK_CREATED, IB_STATE_CHANGED, IB_NEW_TASK_COMMENT, IB_TASK_DONE, IB_CANCELED_TASK, IB_JOINED_TASK,
        IB_TASK_FORWARDED, TASK_EVENT_UPDATED, TASK_APPROVED, TASK_REJECTED_CLOSED, TASK_REJECTED_REOPENED, IB_TASK_APPROVED, IB_TASK_REJECTED_REOPEND,
        IB_TASK_REJECTED_CLOSED, TASK_REOPEN, IB_TASK_REOPEN
    }

    enum class ProjectEvent {
        PROJECT_CREATED, PROJECT_UPDATED, REFRESH_PROJECTS, PROJECT_FLOOR_CREATED,
        PROJECT_GROUP_CREATED, PROJECT_GROUP_UPDATED, PROJECT_GROUP_REMOVED, PROJECT_GROUP_DELETED, DRAWING_FILE_UPLOADED
    }
