...
import com.zstronics.ceibro.ui.tasks.v3.bottomsheets.adapters.UsersHiddenBottomSheetTabLayoutAdapter
import com.zstronics.ceibro.ui.tasks.v3.hidden.TasksHiddenParentTabV3VM

class UsersHiddenBottomSheet(
    val viewModel: TasksHiddenParentTabV3VM,
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter = UsersHiddenBottomSheetTabLayoutAdapter(requireActivity(), viewModel, {
