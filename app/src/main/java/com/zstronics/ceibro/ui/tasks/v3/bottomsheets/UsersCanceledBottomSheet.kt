...
import com.zstronics.ceibro.ui.tasks.v3.bottomsheets.adapters.UsersCanceledBottomSheetTabLayoutAdapter
import com.zstronics.ceibro.ui.tasks.v3.canceled.TasksCanceledV3VM

class UsersCanceledBottomSheet(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter = UsersCanceledBottomSheetTabLayoutAdapter(requireActivity(), viewModel, {
