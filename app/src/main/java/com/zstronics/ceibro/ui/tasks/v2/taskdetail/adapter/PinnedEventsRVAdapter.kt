...
import com.zstronics.ceibro.databinding.LayoutCeibroTaskPinnedEventsBinding
import com.zstronics.ceibro.ui.networkobserver.NetworkConnectivityObserver
import com.zstronics.ceibro.utils.DateUtils

class PinnedEventsRVAdapter constructor(
    val networkConnectivityObserver: NetworkConnectivityObserver,
    val context: Context,
    val downloadedDrawingV2Dao: DownloadedDrawingV2Dao
) :
    RecyclerView.Adapter<PinnedEventsRVAdapter.EventsViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        return EventsViewHolder(
            LayoutCeibroTaskPinnedEventsBinding.inflate(
    ...
    inner class EventsViewHolder(private val binding: LayoutCeibroTaskPinnedEventsBinding) :
...
//            }
            ...
            binding.eventDate.text = "Created: ${DateUtils.formatCreationUTCTimeToCustomForPinnedComments(
                utcTime = item.createdAt,
                inputFormatter = DateUtils.SERVER_DATE_FULL_FORMAT_IN_UTC
            )}"

            binding.pinDate.text = "Pinned: ${DateUtils.formatCreationUTCTimeToCustomForDetailFiles(
                utcTime = item.updatedAt,
                inputFormatter = DateUtils.SERVER_DATE_FULL_FORMAT_IN_UTC
            )}"
            ...
            binding.seenImg.visibility = View.GONE
