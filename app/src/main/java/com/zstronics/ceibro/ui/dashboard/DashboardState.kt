...
class DashboardState @Inject constructor() : BaseState(), IDashboard.State {
    ...
    override val allTasksSelected: MutableLiveData<Boolean> = MutableLiveData(true)
    ...
    override val locationProjectSelected: MutableLiveData<Boolean> = MutableLiveData(false)
    override val locationDrawingSelected: MutableLiveData<Boolean> = MutableLiveData(false)
    override val locationViewSelected: MutableLiveData<Boolean> = MutableLiveData(false)
