...
@AndroidEntryPoint
class UsersFiltersFragment(private val userConnectionAndRolesList: (Pair<ArrayList<AllCeibroConnections.CeibroConnection>, ArrayList<String>>)) :
    ...
    private var userConnectionAndRoleCallBack: ((Pair<ArrayList<AllCeibroConnections.CeibroConnection>, ArrayList<String>>) -> Unit)? =
        null
    ...
    fun setConnectionCallBack(userConnectionCallBack: ((Pair<ArrayList<AllCeibroConnections.CeibroConnection>, ArrayList<String>>) -> Unit)) {
        this.userConnectionAndRoleCallBack = userConnectionCallBack
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.selectedContacts.value = userConnectionAndRolesList.first
