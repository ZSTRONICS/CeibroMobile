...
class AssigneeSelectionAdapter @Inject constructor() :
    RecyclerView.Adapter<AssigneeSelectionAdapter.AssigneeSelectionViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AssigneeSelectionViewHolder {
        return AssigneeSelectionViewHolder(
    ...
    override fun onBindViewHolder(holder: AssigneeSelectionViewHolder, position: Int) {
    ...
    inner class AssigneeSelectionViewHolder(private val binding: LayoutItemAssigneeSelectionBinding) :
