...
@HiltViewModel
class LocationProjectV2VM @Inject constructor(
    override val viewState: LocationProjectV2State,
    val projectsV2Dao: ProjectsV2Dao,
    private val projectRepository: IProjectRepository,
) : HiltBaseViewModel<ILocationProjectV2.State>(), ILocationProjectV2.ViewModel {
