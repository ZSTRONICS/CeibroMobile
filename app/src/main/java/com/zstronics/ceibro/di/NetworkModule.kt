...
class NetworkModule {
    ...
    @Provides
    fun provideInboxV2Dao(database: CeibroDatabase) = database.getInboxV2Dao()

    @Provides
    fun provideDrawingPinsV2Dao(database: CeibroDatabase) = database.getDrawingPinsV2Dao()

    @Provides
    fun provideConnectionsV2Dao(database: CeibroDatabase) = database.getConnectionsV2Dao()

    @Provides
    fun provideTaskDetailFilesV2Dao(database: CeibroDatabase) = database.getTaskDetailFilesV2Dao()
