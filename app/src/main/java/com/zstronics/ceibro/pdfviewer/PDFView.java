 ...
 */
package com.zstronics.ceibro.pdfviewer;
...
import com.zstronics.ceibro.pdfviewer.exception.PageRenderingException;
import com.zstronics.ceibro.pdfviewer.link.DefaultLinkHandler;
import com.zstronics.ceibro.pdfviewer.link.LinkHandler;
import com.zstronics.ceibro.pdfviewer.listener.Callbacks;
import com.zstronics.ceibro.pdfviewer.listener.OnDrawListener;
import com.zstronics.ceibro.pdfviewer.listener.OnErrorListener;
import com.zstronics.ceibro.pdfviewer.listener.OnLoadCompleteListener;
import com.zstronics.ceibro.pdfviewer.listener.OnLongPressListener;
import com.zstronics.ceibro.pdfviewer.listener.OnPageChangeListener;
import com.zstronics.ceibro.pdfviewer.listener.OnPageErrorListener;
import com.zstronics.ceibro.pdfviewer.listener.OnPageScrollListener;
import com.zstronics.ceibro.pdfviewer.listener.OnRenderListener;
import com.zstronics.ceibro.pdfviewer.listener.OnTapListener;
import com.zstronics.ceibro.pdfviewer.model.PagePart;
import com.zstronics.ceibro.pdfviewer.scroll.ScrollHandle;
import com.zstronics.ceibro.pdfviewer.source.AssetSource;
import com.zstronics.ceibro.pdfviewer.source.ByteArraySource;
import com.zstronics.ceibro.pdfviewer.source.DocumentSource;
import com.zstronics.ceibro.pdfviewer.source.FileSource;
import com.zstronics.ceibro.pdfviewer.source.InputStreamSource;
import com.zstronics.ceibro.pdfviewer.source.UriSource;
import com.zstronics.ceibro.pdfviewer.util.Constants;
import com.zstronics.ceibro.pdfviewer.util.FitPolicy;
import com.zstronics.ceibro.pdfviewer.util.MathUtils;
import com.zstronics.ceibro.pdfviewer.util.SnapEdge;
import com.zstronics.ceibro.pdfviewer.util.Util;
...
public class PDFView extends RelativeLayout {
    ...
    public PointF convertScreenPintsToPdfCoordinates(MotionEvent e) {
        ...
        return pdfiumCore.mapPageCoordsToDevice(pdfFile.pdfDocument, page, pageX, pageY, (int) pageSize.getWidth(),
